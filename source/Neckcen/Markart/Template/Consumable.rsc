...
ToolbarDescription toolbar
{
    ...
    String _spriteName = "ClearAll";

    StringTable _stringTable = "Neckcen/Markart/Dialog/StringTable.rsc";
    String _stringName = "Consumable";
    String _stringNameLwr = "ConsumableLwr";
    String _toolTip = "ConsumableTip";
...
{
    RawMaterialFlags _storageFlags = Clothing | Tool | Fuel | Health;
