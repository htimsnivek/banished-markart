StringTable resource
{
	...
	[
        ...
        { String _name = "Food";                               String _text = "Food Markart"; }
        { String _name = "FoodLwr";                            String _text = "food markart"; }
        { String _name = "FoodTip";                            String _text = "Stocks food."; }
        { String _name = "FoodNoGrain";                        String _text = "Food Markart #"; }
        { String _name = "FoodNoGrainLwr";                     String _text = "food markart #"; }
        { String _name = "FoodNoGrainTip";                     String _text = "Stocks food (except cereals)."; }
